...
Font sources are published in a [Github project](https://github.com/silnrsi/font-ruwudu). The build process requires [smith](https://github.com/silnrsi/smith) and project build parameters are set in the [wscript](wscript).    
